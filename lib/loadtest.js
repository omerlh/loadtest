 ...
 *      - indexFactory: the function to use to create the index value in the url
...
var Operation = function(options, Constructor, callback)
{
	...
	function startClients()
	{
		...
		for (var index = 0; index < options.concurrency; index++)
		{
			...
			{
				options.url = url.replaceAll(options.indexParam, options.indexFactory ? options.indexFactory(index) : index);
			}
